...
function btnSignUp() {
  ...
  if (
    inputName.value &&
    inputSID.value.length === 10 &&
    email.includes("@uu.edu.bd") &&
    pass.length >= 6
  ) {
    localStorage.setItem("p-name", document.getElementById("input-name").value);
    window.location.href = "home.html";
...
function deleteAllPosts() {
  ...
  div.innerHTML = `<div id="not-any-post-created" class="bg-[#f4f5f7] w-[calc(100%-20px)] mx-auto h-auto p-5 flex items-start justify-center gap-2 rounded-lg">
                    <div>
